...
Basado en 6 videos temáticos ya grabados:
1. Servidor EC2 con API, BD y Frontend
2. Ajuste inicial del programa
3. Trade en Demo (salida manual y Target automático)
4. Trade Real (salida manual y Target automático)
5. Frontend con registros, datos numéricos e imágenes asociadas al trade
6. Uso de la app móvil mostrando la latencia de ~20 segundos
